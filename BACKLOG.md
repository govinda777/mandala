...
- [x] **Animação de Respiração/Pulsação**: Fazer a mandala pulsar ritmicamente.
  - [x] Implementar `calculatePulse` em `mandala-math.ts`.
  - [x] Adicionar testes unitários.
  - [x] Atualizar renderer para aceitar escala dinâmica.
